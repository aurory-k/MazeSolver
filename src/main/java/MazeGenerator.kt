...
class MazeGenerator {
    companion object {
        val mazeArray = arrayOf(
                ...
                arrayOf(Cell(Position(0, 2), Wall), Cell(Position(1, 2), Free), Cell(Position(2, 2), Free), Cell(Position(3, 2), Wall), Cell(Position(4, 2), Free), Cell(Position(5, 2), Free), Cell(Position(6, 2), Start)),
